...
PLUGIN              ='plugin.audio.radiobanditmetal'
VERSION             ='0.1'
...
listitem = xbmcgui.ListItem('radio_banditmetal',
thumbnailImage='special://home/addons/plugin.audio.radiobanditmetal/icon.png')
